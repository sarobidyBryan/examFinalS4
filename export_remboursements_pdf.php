...
foreach ($remboursements as $r) {
    ...
    $pdf->Cell($widths[2], 8, $r['montant_paye_base'], 1);
    $pdf->Cell($widths[3], 8, $r['montant_paye_interet'], 1);
    $pdf->Cell($widths[4], 8, $r['montant_restant'], 1);
    $pdf->Cell($widths[5], 8, $r['assurance'], 1);
